function FeatureExtractionV4(varargin)
%   FeatureExtractionV2
%   Input:
...
Process.File.Path        = 'D:\CHUM Pharino Master 2011-2013\Master 2011-2013\Research Paper\Matlab code\Signal processing\Feature extraction\Process\Feature Extraction V4';
Process.File.Name{1}     = 'Feature Extraction V4-Input.txt';       % Input file
Process.File.Name{2}     = 'Feature Extraction V4-Output.txt';      % Output file
...
for File = 1:length(Process.File.Dataset{1,1}{1})
    ...
    Process.Data.Temp.STFT.epochSelect  = [0 4];                                %   Choose epoch time from 0 to 4s
    Process.Data.Temp.STFT.freqSelect   = [7 30];                               %   Frequency band from 7 to 30Hz
    
    %   Recode STFT imformation
    
    Process.Data.Main.Information.STFT.Epoch        = Process.Data.Temp.STFT.epochSelect;
    Process.Data.Main.Information.STFT.Frequency    = Process.Data.Temp.STFT.freqSelect;
