...
%%  -----------------------------------------------------------------------
%   Description:
%   Classification_V1: classify band power feature of all electrode EEG
...
Process.File.Path       = 'D:\CHUM Pharino Master 2011-2013\Master 2011-2013\Research Paper\Matlab code\Signal processing\Classification\Process\Classification V1';
Process.File.Name{1}    = 'Classification_V1-Input.txt';   % Input file
Process.File.Name{2}    = 'Classification_V1-Output.txt';  % Output file
